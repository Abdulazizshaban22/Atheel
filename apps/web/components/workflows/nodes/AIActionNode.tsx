...
export type AIActionNodeData = {
  label: string;
  modelHint?: string;
};

export function AIActionNode(props: NodeProps<AIActionNodeData>) {
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'center' }}>
        <div>
          ...
          <div style={{ marginTop: 4, fontSize: 11, color: '#64748b' }}>{data.modelHint || 'إجراء ذكاء اصطناعي'}</div>
        </div>
